<?php
	...
	function hitung_tagihan_awal($hargaSatuan, $jumlahPesanan){
		...
		return $tagihanAwal; 
		//function adalah instruksi kepada PHP bahwa kita akan membuat fungsi
		//hitung_tagihan_awal adalah nama dari fungsi yang ingin kita eksekusi
		//$hargaSatuan dan $jumlahPesanan adalah parameter
		//return adalah perintah khusus untuk fungsi, dimana kata return menginstruksikan kepada PHP bahwa pemrosesan fungsi telah selesai. 
	}
			...
			<div class="row">
				...
				<div class="col-lg-2">
					...
					<?php
						...
						foreach ($cabang as $c){
							printf('<option value="">%s</option>', $c);
							//Fungsi printf() adalah fungsi untuk memformat teks atau string.
							//lalu simbol %s adalah sebuah placeholder untuk teks (string).
						}
					?>	
					</select>
				</div>
